...
public:
    ...
    virtual void insert(elemType& insertItem) = 0;
...
private:
    ...
    void destroy(nodeType<elemType>* &p);
      ...
      //               deallocated.
      //               p = NULL;
    std::string out(string welcome) const;
...
template <class elemType>
std::string binaryTreeType<elemType>::out
(string welcome) const
{
    return (welcome);
}

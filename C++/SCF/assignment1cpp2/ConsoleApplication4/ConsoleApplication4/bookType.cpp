...
BookType updateInfo(BookType obj) {
	...
	std::cout << "Update Author(s) " << std::endl;
		while (i < 4)
		{
			std::cout << std::endl;
			std::cout << "Type in one to four Authors Names then press [Enter]" << std::endl << "(type [0] to skip)" << std::endl;
